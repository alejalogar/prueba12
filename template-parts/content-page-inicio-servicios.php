...
?>
<div class="row full_img" style="background-image:url(<?php echo get_template_directory_uri() . '/img/01.jpg'; ?>)"></div>

<div class="row section">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="servicios">
...
<div class="row entradilla2">
    <div class="col-lg-6 col-md-6 col-sm-10 col-xs-10">
        ...
        data-aos="fade-up"
        data-aos-duration="1200" style="padding:0;">Nosotros nos encargamos de todo.</h1>
    </div>
</div>
...
<div class="row servicios1">
    ...
    <div class="col-lg-5 col-lg-offset-1 col-md-5 col-md-offset-2 col-sm-5 col-sm-offset-1 col-xs-11 col-xs-offset-1 slider trans_width">
        <img class="img-responsive" src="<?php echo get_template_directory_uri() . '/img/04.jpg'; ?>" width="100%">
    </div>
</div>
...
<div class="row servicios3">
    <div class="col-lg-3 col-lg-offset-1 col-md-12 col-sm-12 col-xs-12 servicios3__col">
