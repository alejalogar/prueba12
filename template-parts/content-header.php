...
<div class="row header" id="header">
    ...
    <div class="col-lg-4 col-lg-offset-2 col-md-3 col-sm-3 col-xs-8 trans_width header-logo-wrap">
    ...
    <div class="col-lg-5 col-md-6 col-sm-6 hidden-xs header__trabajo trans_width">
        <div class="row header__trabajo__row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 header__trabajo__row__btn <?php echo $link_class; ?>" data-url="<?php echo $trabajadores_url; ?>" id="trabajadores-btn">
                    <!--<h5><a href="<?php // echo $base_link; ?>#trabajadores">BUSCO TRABAJADORES</a></h5>-->
                <h5>BUSCO TRABAJADORES</h5>
                </div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 header__trabajo__row__btn <?php echo $link_class; ?>" data-url="<?php echo $trabajo_url; ?>" id="trabajo-btn">
                    <h5>BUSCO TRABAJO</h5>
                </div>
        </div>
    </div>
